        ...
        <div class="main" style="height:auto;">
            <div class="pform" style="height:100%; margin-bottom:100px">
                ...
                <table style="width:70%; line-height: 10px;" cellpadding=5 align="center">
                    <form action="addteacher.php" method="post" align="center">
                        <tr>
                            <td class="littlegrayline">教師編號</td>
                            <td class="littlegrayline"><input type="text" name="tid"></td>
                        </tr>
                        <tr>
                            <td class="littlegrayline">教師姓名</td>
                            <td class="littlegrayline"><input type="text" name="tname"></td>
                        </tr>
                        <tr>
                            <td class="littlegrayline">預設密碼</td>
                            <td class="littlegrayline"><input type="password" name="tpwd"></td>
                        </tr>
                        <tr>
