...
<body>
  ...
  <div class="content" align='center'>
    <div class="main">
      <div>
        <font size="10">產品進貨清單</font>
      </div>
      <div class="pform" align="center">
        <table cellpadding=10 style="border-collapse:collapse; width:50%; height:auto; table-layout:fixed;">
          <form action="./buy_filter.php?sid=<?php echo $_SESSION["ID"] ?>" method="post" align="center" style="line-height: 10px;">
            <tr>
              <td>
        ...
        <?php
        $SQL = "SELECT * FROM buyrecord B, product P WHERE B.product_id=P.product_id";
        ...
        if ($result = mysqli_query($link, $SQL)) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<tr class='color3' style='height:10px'>
                      ...
                      <td align='center'>" . $row["buy_num"] . "</td>
                      <td align='center'>" . $row["buy_date"] . "</td></tr>";
        ...
        for ($i = 1; $i <= $pages; $i++) {
          if ($page - 3 < $i && $i < $page + 3) {
            if($i == $page){
              echo "<a href=?page=" . $i . " style='text-decoration:none;'><font size='5'>" . $i . "</font></a> ";
            }else{
              echo "<a href=?page=" . $i . " style='text-decoration:none;'>" . $i . "</a> ";
            }
          }
        }
        echo " 頁 <a href=?page=" . $pages . " style='text-decoration:none;'>末頁</a><br /><br />";
        ?>
      </div>
    </div>
