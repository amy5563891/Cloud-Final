...
<header class="p-3 text-bg-dark">
    ...
    <div class="content" >
        ...
        <form action="../info.php" method="post" align="center" style="margin-top:30px">
            <h1 class="h3 mb-3 fw-normal">Please sign in</h1>

            <div class="form-floating">
            <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="acct" required>
            <label for="floatingInput">Account</label>
            </div>
            <div class="form-floating">
            <input type="password" class="form-control" name="pwd" id="" placeholder="Password" required>
